...
#Region "Caption/ WindowText"
    ...
    Public Shared Function GetWindowText(ByVal hwnd As Integer, ByVal lpString As Text.StringBuilder, ByVal cch As Integer) As Integer
    End Function
...
#End Region
    ...
    Public Shared Sub CheckIfAppIsAllreadyRunning()
        Dim pProcess As Process() = Process.GetProcessesByName("Quartus")
    ...
    Public Shared Sub RestartIfCsgoNotValid()
        If Process.GetProcessesByName("csgo").Length <= 0 Then
            Dim RunningProcess() As Process = Process.GetProcessesByName("Quartus")
