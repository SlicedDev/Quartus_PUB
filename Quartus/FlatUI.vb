...
#Region " Dark Colors"
        ...
        Private _HeaderColor As Color = Color.FromArgb(47, 54, 64)
        Private _BaseColor As Color = Color.FromArgb(53, 59, 72)
...
#End Region
        ...
        Protected Overrides Sub OnPaint(e As PaintEventArgs)
            ...
            With G
                ...
                .FillPath(New SolidBrush(Color.FromArgb(53, 59, 72)), GP3)
            ...
            With G
                ...
                Select Case O
                    ...
                    Case _Options.Style4
                        ...
                        '-- Text
                        .DrawString("1", Font, New SolidBrush(BaseColor), New Rectangle(-12, 2, W, H), CenterSF)
                        ...
                        If Checked Then
                            ...
                            '-- Text
                            .DrawString("2", Font, New SolidBrush(BaseColorBlue), New Rectangle(12, 2, W, H), CenterSF)
                        End If
                End Select
...
#End Region
        ...
        Sub New()
            ...
            TB = New System.Windows.Forms.TextBox With {
                .Font = New Font("Segoe UI", 10),
                .Text = Text,
...
#Region " Colors"
        ...
        Private BGColor As Color = Color.FromArgb(53, 59, 72)
        Private _BaseColor As Color = Color.FromArgb(53, 59, 72)
...
#Region " Colors"
            ...
            Private BorderColor As Color = Color.FromArgb(53, 59, 72)
